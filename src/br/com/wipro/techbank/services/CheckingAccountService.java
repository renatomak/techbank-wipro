...
public class CheckingAccountService {
    ...
    public void save(CheckingAccount checkingAccount) {
        ...
        if (existAccount != null) {
            ...
            System.out.println("CheckingAccount adicionado com sucesso.\n");
    ...
    public void deleteById(Long number) {
        ...
        if (checkingAccount != null) {
            System.out.printf("CheckingAccount com ID %d foi removido com sucesso!\n", number);
        } else {
            System.out.printf("Erro ao tentar remover o checkingAccount com ID %d.\n", number);
        }
    }
    ...
    public CheckingAccount update(CheckingAccount checkingAccount) {
        ...
        if (index == -1) {
            System.out.printf("CheckingAccount com ID %d não existe.\n", index);
            return null;
        }
